...
void QA_hxhy_V0T0(Int_t Fill, const char *rate_name1, const char *rate_name2, const char *rate_type, const char *sep_type,
              ...
              Bool_t save = kTRUE)
{
    ...
    TH1D* hxhy_V0_1 = GetHistogram(rate_name2,rate_type,sep_type,intensity_type,fit_type,1);
    TH1D* hxhy_T0_0 = GetHistogram(rate_name1,rate_type,sep_type,intensity_type,fit_type,0);
    TH1D* hxhy_T0_1 = GetHistogram(rate_name1,rate_type,sep_type,intensity_type,fit_type,1);
